...
import ru.smartbandage.android.databinding.BtActivityMainBinding
import timber.log.Timber

private const val PERMISSION_REQUEST_CODE = 1

class BT_MainActivity : AppCompatActivity() {

    /*******************************************
     * Properties
     *******************************************/

    private lateinit var binding: BtActivityMainBinding
    ...
    private val scanResultAdapter: ScanResultAdapter by lazy {
        ScanResultAdapter(scanResults) { result ->
            ...
            with(result.device) {
                ...
                ConnectionManager.connect(this, this@BT_MainActivity)
            }
        }
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = BtActivityMainBinding.inflate(layoutInflater)
